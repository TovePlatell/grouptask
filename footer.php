    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-home me-3"></i> Gustavslundsvägen 123, 16733 Bromma, Sweden</p>
          <p>
            <i class="fas fa-envelope me-3"></i>
            info@example.com
          </p>
          <p><i class="fas fa-phone me-3"></i> + 46 123 123 12</p>
          <p><i class="fas fa-print me-3"></i> + 46 123 123 23</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
